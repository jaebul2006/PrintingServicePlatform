...
<title>CAST & Splint Regist Form</title>
</head>
<body>

	<form name="form1" class="form-signin" method="post" action="CastSplintCompanyRegist"> 
        <div class="form-container">
          ...
          <button class="btn btn-lg btn-primary p-btn btn-block" type="submit" id="BtnCastSplintCompanyRegist">등록하기</button>
        </div>  
    </form> 
