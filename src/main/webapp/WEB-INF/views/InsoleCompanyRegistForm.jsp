...
<body>
	...
	<form name="form1" class="form-signin" method="post" action="InsoleCompanyRegist"> 
        <div class="form-container">
          ...
          <button class="btn btn-lg btn-primary p-btn btn-block" type="submit" id="BtnInsoleCompanyRegist">등록하기</button>
        </div>  
    </form>
